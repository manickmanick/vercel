              ...
              <div className="space-y-6">
                <GlassmorphicCard>
                  <p className="text-lg text-zinc-300">
                    ...
                    Passionate about turning ideas into reliable digital
                    products and continuously improving my craft.
                  </p>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-8">
                    <div className="space-y-1">
                      ...
                      <div className="font-medium">Manickaperumal</div>
                    </div>
                    <div className="space-y-1">
                      <div className="text-sm text-zinc-500">Email</div>
                      <div className="font-medium">manicm265@gmail.com</div>
                    </div>
                    <div className="space-y-1">
        ...
        <section id="skills" className="py-32 relative">
          ...
          <div className="container relative z-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-16">
              ...
              <SkillBadge name="REST API" level={75} />
              <SkillBadge name="PostgreSQL" level={70} />
              <SkillBadge name="AWS" level={65} />
              <SkillBadge name="Docker" level={40} />
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-medium">github.com/manickmanick</div>
                    </div>
                  </div>
                </div>
